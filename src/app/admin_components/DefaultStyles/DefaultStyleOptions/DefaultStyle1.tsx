...
function DefaultStyle1({ data, sectionsList, sectionListIndex, setSectionsList }: { data: any, sectionsList: any, sectionListIndex: any, setSectionsList: any }) {
    ...
    // const saveSection = (updatedGrid: any) => {
    ...
    //     // const components = updatedSectionList[sectionListIndex].components.grid
    ...
    return (
        <div
            className={`border-dashed  mx-auto border-2 w-full overflow-hidden `}>
            ...
            <div className='flex  gap-10 rounded w-full group ' style={{
    ...
    >
        {
            Array(Number(gridCols)).fill(null).map((value: any, sectionListIndex: number) => (
                <div className='border' key={sectionListIndex} onClick={() => {
