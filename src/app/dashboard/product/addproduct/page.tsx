...
function AddProduct() {
    ...
    const [finalCategory, setFinalCategory] = useState<any>(null);

    const [showImageAddModal, setShowImageAddModal] = useState(false)
    const [showFileAddModal, setFileAddModal] = useState(false)
    ...
    const addProductDetail = async (values: any, actions: any) => {
        try {
        ...
        <div>
            {
                ...
                <SelectCategoryModal showModal={showCategoryAddModal} setShowModal={setShowCategoryAddModal} finalCategory={finalCategory} setFinalCategory={setFinalCategory} />
            }

            {
                showImageAddModal &&
                <SelectFile accept="image" showModal={showImageAddModal} setShowModal={setShowImageAddModal} setSelectedFile={setSelectedImage} selectedFile={selectedImage} />
            }
            {
                showFileAddModal &&
                <SelectFile accept="file" showModal={showFileAddModal} setShowModal={setFileAddModal} setSelectedFile={setUserGuide} selectedFile={userGuide} />
            }
                ...
                <div className='card'>
                    ...
                    <Formik
                        ...
                        onSubmit={(values, actions) => {
                            addProductDetail(values, actions)
