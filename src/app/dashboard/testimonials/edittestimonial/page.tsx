...
function EditTestimonial() {
    ...
    const selectedTestimonial = useAppSelector((state) => state.testimonialSlice.value)
    const [currentImage, setCurrentImage] = useState<any>(() => selectedTestimonial.image)
    ...
    const addTestimonialDetail = async (values: any, actions: any) => {
        try {
            ...
            let result = await axios.put('testimonial/' + selectedTestimonial._id, formData)
                                ...
                                <div className='grid md:grid-cols-2 grid-cols-1 gap-4'>
                                    ...
                                    <div className=''>
                                        ...
                                        <button
                                            ...
                                            className='btn-dashed w-full h-20 mb-3'
                                        >
                                            Upload
                                        </button>
                                        {image && (
